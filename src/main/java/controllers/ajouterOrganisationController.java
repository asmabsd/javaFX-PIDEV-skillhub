...
Organisation organisationajoutee;
   ...
   /* @FXML
    ...
    public static final String AUTH_TOKEN = "fa7df3c1e85df9d254fc9c8366f19459";
...
*/
   ...
   @FXML
    public static void sendEmail(String to, String subject, String body) {
        ...
        String username = "atouanirana@gmail.com";
        String password = "eafczhobtosqclvw";
    ...
    private void handleSendButtonClick(ActionEvent event) {
        // Récupérer l'adresse e-mail de l'organisation à partir de la base de données
        String organisationEmail = organisationajoutee.getEmail(); // Remplacez getEmailFromDatabase() par votre méthode de récupération depuis la base de données

        // Vérifier si l'adresse e-mail de l'organisation est valide
        if (organisationEmail != null && !organisationEmail.isEmpty()) {
            // Appeler la méthode sendEmail avec l'adresse e-mail de l'organisation
            sendEmail(organisationEmail, "Confirmation", "Votre email a été confirmé avec succès.");
        } else {
            // Afficher une alerte si l'adresse e-mail de l'organisation n'est pas disponible
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setTitle("Aucune adresse e-mail disponible");
            alert.setHeaderText(null);
            alert.setContentText("L'adresse e-mail de l'organisation n'est pas disponible.");
            alert.showAndWait();
        }
    }
